  ...
  return (
    <View  style={{backgroundColor : '#000000', flex: 1}}> 
      ...
      <View style={{paddingLeft: 35, paddingTop: 15, paddingRight: 35}}>
        <Text style={{ fontFamily: 'ABeeZee-Regular', color:'#d1d1d1', fontSize: 14,textAlign: "center"}}>Pendaftaran Berhasil Akun berhasil dibuat silahkan masuk</Text>
      </View>
      ...
      <View style={{alignSelf: 'center', paddingTop: 25}}>
        ...
        onPress={()=> {
          ...
          >
          <Text style={{fontSize: 20, fontFamily: 'NotoSansTC-Bold-Alphabetic', color: 'black', textAlign: 'center', fontWeight:'900'}}>Login</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
}
export default RegisterBerhasil;